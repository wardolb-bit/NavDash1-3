...
export function MsiConsoleSkin() {
  ...
  useEffect(() => {
    ...
    if (!style) {
      ...
      style.textContent = `
        .bc-msi-console { background:#04080c !important; color:#dbe5ee !important; padding:6px !important; font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif !important; }
        .bc-msi-console > div { max-width:none !important; margin:0 !important; gap:5px !important; }
        .bc-msi-console section, .bc-msi-console article { border-radius:0 !important; box-shadow:none !important; backdrop-filter:none !important; border-color:rgba(148,163,184,.14) !important; background:#071019 !important; }
        .bc-msi-console section:first-child { border-color:rgba(201,162,39,.30) !important; }
        ...
        .bc-msi-console input, .bc-msi-console select { border-radius:0 !important; border-color:#33485a !important; background:#04080c !important; color:#dbe5ee !important; box-shadow:none !important; }
        .bc-msi-console pre { background:#04080c !important; border:1px solid rgba(148,163,184,.14); padding:12px !important; }
        ...
        html[data-navdash-theme="day"] .bc-msi-console [class*="text-slate-300"] { color:#17212b !important; }
        html[data-navdash-theme="day"] .bc-msi-console [class*="text-slate-400"],
        html[data-navdash-theme="day"] .bc-msi-console [class*="text-slate-500"] { color:#586773 !important; }
      `;
