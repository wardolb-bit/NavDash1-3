...
.bc2-actionbar{margin-bottom:18px!important;padding:8px!important;border:1px solid var(--border)!important;border-radius:12px!important;background:var(--panel)!important;box-shadow:0 18px 55px var(--shadow)!important;backdrop-filter:none!important}.bc2-actionbar>div{display:flex!important;align-items:center!important;justify-content:flex-end!important;gap:7px!important}main:has(#bc-v2-topbar) .bc2-actionbar button,main:has(#bc-v2-topbar) .bc2-actionbar label,main:has(#bc-v2-topbar) .bc2-actionbar a{width:auto!important;min-width:94px!important;height:38px!important;padding:0 12px!important;border:1px solid #31506a!important;border-radius:7px!important;background:#0a1a2a!important;color:var(--text)!important;box-shadow:none!important;font-size:11px!important;font-weight:700!important}.navdash-v12-day .bc2-actionbar button,.navdash-v12-day .bc2-actionbar label,.navdash-v12-day .bc2-actionbar a{background:#fff!important;border-color:var(--border)!important}
