...
export function NavDashNav() {
  ...
  if (pathname === "/" || pathname === "/navdash" || pathname.startsWith("/wx-routing") || pathname.startsWith("/tools") || pathname.startsWith("/tides") || pathname.startsWith("/device-access")) return null;
