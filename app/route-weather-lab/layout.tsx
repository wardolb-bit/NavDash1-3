    ...
    <>
      <style>{`
        ...
        aside > section:first-child .grid.grid-cols-2 {
          grid-template-columns: minmax(0, 1.6fr) minmax(82px, .7fr) !important;
          align-items: end;
        }
        ...
        /* Make the actual sea and wind traces unmistakable. */
        ...
        /* Expected-vessel cursor gets a brighter selected-time marker. */
