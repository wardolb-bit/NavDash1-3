...
export default function NavDashRouteConsolePage() {
        ...
        <section className="mt-5 grid gap-5 xl:grid-cols-3">
          <div id="v12-section-offline" className={panelClass}>
            ...
            <p className={`mt-4 text-sm leading-6 ${mutedClass}`}>
              Offline support keeps shipboard route, weather, coastline, and watch information available during network interruptions.
            </p>
          </div>
          ...
          <div id="v12-section-build" className={panelClass}>
            ...
            <h3 className="mt-1 text-2xl font-black">NavDash 1.3</h3>
            <div className={`mt-4 grid gap-2 text-sm ${mutedClass}`}>
              <div>Build Type: Shipboard dashboard</div>
